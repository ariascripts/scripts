--[[IMPORTANT: Make sure your bank is full and:
...
local familiars = {
    {name = "Geyser titan", level = 89, pouch_id = 12786, charm = "Blue charm", secondary = "Water talisman",
        secondary_unnoted = 1444, secondary_noted = 1445, sellMethod = true},
    {name = "Fire titan", level = 79, pouch_id = 12802, charm = "Blue charm", secondary = "Fire talisman",
        secondary_unnoted = 1442, secondary_noted = 1443, sellMethod = true},
    {name = "Spirit jelly", level = 55, pouch_id = 12027, charm = "Blue charm", secondary = "Jug of water",
        secondary_unnoted = 1937, secondary_noted = 1938, sellMethod = true},
}
...
local function getCreationInterfaceSelectedItemID()
    return API.VB_FindPSett(1170, 1, 0).state
end
...
while API.Read_LoopyLoop() do
    ...
    elseif UTILS.distance(SUMMONING_SHOP) >= 1 then
